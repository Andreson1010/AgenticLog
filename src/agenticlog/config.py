...
LLM_API_KEY: str = os.environ["OPENAI_API_KEY"]          # chave carregada do .env ou variável de ambiente
LLM_API_BASE: str = os.environ["OPENAI_API_BASE"]        # endpoint carregado do .env ou variável de ambiente
